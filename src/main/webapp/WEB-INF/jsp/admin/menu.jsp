...
<ul class="nav navbar-nav">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li${menuitem == 'livestreams' ? ' class="active"' : ''}><stripes:link beanclass="nl.opengeogroep.safetymaps.server.admin.stripes.LivestreamsActionBean">Actieve livestreams</stripes:link></li>
        </ul>
    </li>
    <li class="dropdown">
